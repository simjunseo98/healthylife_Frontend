...
const Mypage = () => {
  ...
  <h1 className="p-4 text-4xl">({user?.username})님의 마이페이지</h1>
  <div className="w-full flex justify-between bg-white border-2 border-emerald-400 p-5">
      <div className="w-full max-w-[200px] border-r-2 border-emerald-400">
      프로필이미지</div>
